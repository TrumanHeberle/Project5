...
public class PersonScannerTest extends TestCase {
    private LinkedSongList<String> list;
    private Song song1;
    private Song song2;
    private Song song3;
     ...
     */
    public void setUp() {
        list = new LinkedSongList<String>();
        song1 = new Song("Watching the Detectives", "Elvis Costello", 1977, "punk");
    ...
    public void testScanPeople() {
        LinkedSongList<String> list1 = new LinkedSongList<String>();
        song1 = new Song("Watching the Detectives", "Elvis Costello", 1977, "punk");
        song2 = new Song("Upside Down", "Diana Ross", 1980, "disco");
        song3 = new Song("Uma Thurman", "Fall Out Boy", 2015, "rock");
        list1.add(0, song3);
